...
pindel/%.$1.pindel_timestamp : pindel/config/%.pindel_config.txt
	$$(call RUN,-n 16 -s 28G -m 30G -w 10080,"$$(MKDIR) pindel/$$* && $$(PINDEL) -T 16 -f $$(REF_FASTA) -i $$< -o pindel/$$*/$1 -c $1 && touch $$@")
endef
...
pindel/chr_vcf/%.pindel_$1.vcf : pindel/%.$1.pindel_timestamp
	$$(call RUN,-c -s 12G -m 16G,"$$(PINDEL2VCF) -P pindel/$$*/$1 -v $$@.tmp -c $1 -r $$(REF_FASTA) -R $$(REF_NAME) -d $$(REF_DATE) $$(PINDEL2VCF_OPTS) && $$(call VERIFY_VCF,$$@.tmp,$$@)")
endef
...
pindel/vcf/$1.pindel.vcf : $$(foreach chr,$$(CHROMOSOMES),pindel/chr_vcf/$1.pindel_$$(chr).vcf)
	$$(call RUN,-s 16G -m 24G,"(grep '^#' $$<; grep -v '^#' $$^ ) | $$(VCF_SORT) $$(REF_DICT) - > $$@.tmp && $$(call VERIFY_VCF,$$@.tmp,$$@)")
endef
...
vcf/$1_$2.pindel.vcf : pindel/vcf/$1_$2.pindel.vcf
	$$(call RUN,-c -s 16G -m 32G,"$$(PINDEL_SOMATIC_AD_FILTER_VCF) --tumor $1 --normal $2 --pass_only $$< | $$(PINDEL_SOURCE_ANN_VCF) > $$@.tmp && $$(call VERIFY_VCF,$$@.tmp,$$@)")
endef
